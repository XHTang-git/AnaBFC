...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--semi_supervised', type=bool, default=True, help='use semi-supervised')
        self.parser.add_argument('--unlabeled_ratio', type=float, default=0.7, help='training ratio of unlabeled image')
